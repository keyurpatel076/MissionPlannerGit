...
namespace MissionPlanner.Wizard
{
    public partial class Wizard : Form
    {
        ...
        public Wizard(bool is384SetupWizard = false)
        {
            instance = this;
            ...
            {
                wiz_main.AddScreen(new MainSwitcher.Screen("384_Intro", new _384_1Intro(), true));
                wiz_main.AddScreen(new MainSwitcher.Screen("384_LoadFW", new _384_2LoadFW(), true));

                wiz_main.ShowScreen("384_Intro");
            }
